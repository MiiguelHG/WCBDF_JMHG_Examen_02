package com.upiiz.examenll.controllers;

import com.upiiz.examenll.entities.CustomResponse;
import com.upiiz.examenll.entities.InvoiceEntity;
import com.upiiz.examenll.services.InvoiceService;
...
public class InvoiceController {
    ...
    public ResponseEntity<CustomResponse<List<InvoiceEntity>>> findAllInvoices() {
        ...
        try {
            ...
            CustomResponse<List<InvoiceEntity>> response = new CustomResponse<>(0, "Error al obtener las facturas", null, links);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
        }
    }
    ...
    public ResponseEntity<CustomResponse<InvoiceEntity>> findInvoiceById(@PathVariable Long id) {
        ...
        try {
            ...
            CustomResponse<InvoiceEntity> response = new CustomResponse<>(0, "Error al obtener la factura", null, links);
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(response);
        }
    }
    ...
    public ResponseEntity<CustomResponse<InvoiceEntity>> deleteInvoice(@PathVariable Long id) {
        ...
        try {
            Boolean invoiceDeleted = invoiceService.deleteInvoice(id);
